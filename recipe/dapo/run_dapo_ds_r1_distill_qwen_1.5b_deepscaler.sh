...
trainer_epochs=2 # DeepScaleR contains ~40k rows; with batches of 256, each epoch is around 150 training steps
trainer_log_val_generations=5
trainer_save_freq=200 # save model every 100 steps
